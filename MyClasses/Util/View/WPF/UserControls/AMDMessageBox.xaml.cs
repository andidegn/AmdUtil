...
{
  internal class ButtonTextConverter : IMultiValueConverter
  {
    public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
    {
      return values[0] is string s && !string.IsNullOrWhiteSpace(s) ? s : values[1];
    }
  ...
  public sealed partial class AMDMessageBox : Window
  {
    ...
    public static readonly DependencyProperty IconVisibilityProperty =
        DependencyProperty.Register("IconVisibility", typeof(Visibility), typeof(AMDMessageBox), new PropertyMetadata(Visibility.Collapsed));
    ...
    public static readonly DependencyProperty IconProperty =
        DependencyProperty.Register("Icon", typeof(ControlTemplate), typeof(AMDMessageBox), new PropertyMetadata(default(ControlTemplate)));
    ...
    public static readonly DependencyProperty CaptionProperty =
        DependencyProperty.Register("Caption", typeof(string), typeof(AMDMessageBox), new PropertyMetadata(default(string)));
    ...
    public static readonly DependencyProperty MessageProperty =
        DependencyProperty.Register("Message", typeof(string), typeof(AMDMessageBox), new PropertyMetadata(default(string)));
    ...
    public static readonly DependencyProperty CustomButtonText1Property =
        DependencyProperty.Register("CustomButtonText1", typeof(string), typeof(AMDMessageBox), new PropertyMetadata(null));
    ...
    public static readonly DependencyProperty CustomButtonText2Property =
        DependencyProperty.Register("CustomButtonText2", typeof(string), typeof(AMDMessageBox), new PropertyMetadata(null));
    ...
    public static readonly DependencyProperty CustomButtonText3Property =
        DependencyProperty.Register("CustomButtonText3", typeof(string), typeof(AMDMessageBox), new PropertyMetadata(null));
    ...
    public static int Show(string messageBoxText, string caption, MessageBoxImage icon, int defaultResult, MessageBoxOptions options, params string[] customButtonTexts)
    {
    ...
    public static int Show(Window owner, string messageBoxText, string caption, MessageBoxImage icon, int defaultResult, MessageBoxOptions options, params string[] customButtonTexts)
    {
    ...
    internal static MessageBoxResult ShowCore(Window owner, string messageBoxText, string caption, MessageBoxButton button, MessageBoxImage icon, MessageBoxResult defaultResult)
    {
      ...
      AMDMessageBox amdmb = new AMDMessageBox()
      {
        Caption = caption,
