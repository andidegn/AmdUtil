...
namespace AMD.Util.View.WPF.UserControls
{
  ...
  public partial class ColorPicker2 : UserControl
  {
    ...
    public static readonly DependencyProperty ColorHsvProperty =
        DependencyProperty.Register("ColorHsv", typeof(ColorHSV), typeof(ColorPicker2), new PropertyMetadata(new ColorHSV(0xFF, 0, 0, 1)));
    ...
    public static readonly DependencyProperty SelectedBrushProperty =
        DependencyProperty.Register("SelectedBrush", typeof(SolidColorBrush), typeof(ColorPicker2), new PropertyMetadata(default(Brush), SelectedBrushPropertyCallback));

    private static void SelectedBrushPropertyCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
      ColorPicker2 cp = d as ColorPicker2;
    ...
    public static readonly DependencyProperty OriginalBrushProperty =
        DependencyProperty.Register("OriginalBrush", typeof(SolidColorBrush), typeof(ColorPicker2), new PropertyMetadata(default(Brush)));
    ...
    public static readonly DependencyProperty CurrentBaseColorProperty =
        DependencyProperty.Register("CurrentBaseColor", typeof(Color), typeof(ColorPicker2), new PropertyMetadata(Colors.Red));
    ...
    private void SetColorHueFromPicker()
    {
      ...
      double hue = 360 * mousePosition.Y / rectColorHue.ActualHeight;
    ...
    {
      double d = hue * (rectColorHue.ActualHeight + 3) / 359.99999;
      Canvas.SetTop(rectColorHueSelector, Math.Min(d, rectColorHue.ActualHeight));
    }
    #endregion // Selectors
