...
namespace AMD.Util.Devices
{
  public static class DeviceNotification
  {
    ...
    {
      DevBroadcastDeviceInterface dbi = CreateBroadcastDeviceInterface(GuidDeviceInterfaceMonitorDevice);
    ...
    {
      DevBroadcastDeviceInterface dbi = CreateBroadcastDeviceInterface(GuidDeviceInterfaceUSBDevice);
    ...
    {
      DevBroadcastDeviceInterface hdr = Marshal.PtrToStructure<DevBroadcastDeviceInterface>(lParam);
      ...
      DevBroadcastDeviceInterface devIF = Marshal.PtrToStructure<DevBroadcastDeviceInterface>(lParam);
